...
\macro\MTlabel[cc](s)*"Text";= adding a label to the current figure.
...
parameter between square brackets, |[cc]| in the example, as
...
|[cc]|, that is, its center.  The asterisk preceding the text is
also optional and it can take any value, but only if it takes value
