...
El fichero "doc.tex" usa el formato "esplain.fmt" y
llama a los ficheros "explain.tex", "fonts.tex" e "indexes.tex",
de manera que puede hacer uso de todas los comandos (o macros) de:
"plain", "esplain", "explain", "fonts" e "indexes", además
...
"\font\sf=cmss10 scaled1200", o,
si se usan las fuentes Latin Modern,
"\font\sf=texnansi-lmss12"
...
Esto es {\TeX}, así que vale
$\delta$, $\sqrt2 \approx 1.41$, $\cal P$, o:
$$\sum_{i=0}^\infty {1\over 2^i} = 2$$
