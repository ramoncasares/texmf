...
\copyright\ 2020 Ramón Casares; licensed as {\tt cc-by}.\\
...
\command\xsubsection{Subsection title}: Starts and prints
 ...
 and if the previous paragraph was not numbered,
  then its paragraps  will not be numbered.
...
In adition, by default, every sectioning command adds
...
File "auxiliar.toc" is composed of lines formated:
...
\command\itemitem{1.1}: Starts a generic sub-item.
