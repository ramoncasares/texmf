...
\def\macro #1 ={\par\hang\noindent{\tt #1}\quad\ignorespaces}

%%% PRINCIPIO DEL TEXTO %%%

\centerline{{\tt graphbase.mf} en \MT}\smallskip

Pasos a seguir para usar "graphbase.mf" con {\MT}, o sea en un
fichero que ya importó {\MT} haciendo "\input metatex.tex".

\describe1: Llamar al fichero "graphbase.tex" que incluye las macros
que adaptan mfpic a {\MT}.

"\input graphbase.tex"

\describe2: Cada vez que se quieran utilizar las macros de "graphbase.mf"
...
\describe3: Los caracteres que utilicen las macros de "graphbase.mf"
deben ser declarados utilizando un "beginchar" propio.

"\mfpicbeginchar(wd,ht,dp);"

\describe4: Para finalizar la definición de un caracter también debe
utilizarse una orden propia.

"\mfpicendchar;"

\describe5: Por último, para cerrar el entorno, se escribirá.
