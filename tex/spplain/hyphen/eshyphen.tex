...
\catcode`\@=11 % because utf changes it to 12
\deactivatehigh % because utf does a \utfon

\def\activate{\def\do##1{\catcode`##1=13}}
\def\deactivate{\def\do##1{\catcode`##1=12}}
\def\stringate{\def\do##1{\def##1{\string##1}}} % only do this to active chars
\def\noexpandate{\def\do##1{\def##1{\noexpand##1}}} % only to active
