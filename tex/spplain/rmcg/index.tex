...
% Check file auxiliar.aux

\newif\ifauxf
\newread\infile \openin\infile=auxiliar.aux
...
\def\files{\begingroup \stringate\dohigh\stringaccents
 ...
 \ifauxf
  ...
  \pdft@toc0\pdfcode
  \def\tocline##1##2##3##4##5{{\stringate\doaccents\dosymbols
   \stringaccents \pdf@ut \def\4{##4}\ifnum##1>5\def\4{}\fi
