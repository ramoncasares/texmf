...
\outer\def\subsection#1{\vskip0pt plus 42pt\penalty-250\vskip0pt plus-42pt
 ...
 \noindent{\fontthree\secid\ #1\pdflabel\toc3{#1}\lbl{#1}{\secid}}\par
 \everypar{\numberedpars}}
...
\def\URL#1<{\def\1{#1}\begingroup\catcode`\#=12\@RL}
