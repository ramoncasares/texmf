...
\def\new/#1\wen/{\truecolor{\colornew}#1\endcolor
 \ifvmode\nointerlineskip\marginalstar\else\vadjust{\marginalstar}\fi}
\def\wen/{\errmessage{Error! Unnested wen.}}
