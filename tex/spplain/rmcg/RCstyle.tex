...
\def\numberedpars{\global\advance\parno1
 \def\secid{\presec\the\secno\ifnum\ssecno>0.\the\ssecno\fi\prepar\the\parno}%
...
\def\colornew{Red}\def\colordel{White}\chardef\diffchar=`*

\def\marginalstar{\vbox to 0pt{\kern-9pt
 \llap{\tt\truecolor{\colornew}\diffchar\endcolor\quad}\vss}}

% \long\def\new/#1\wen/{\diff{#1}{}}
% \long\def\del/#1\led/{\diff{}{#1}}
% \def\mod[#1<#2]{\diff{#1}{#2}}
%
% \long\def\diff#1#2{\def\diffon@{#1}\def\difftw@{#2}\let\diffn@xt=\relax
%  \ifx\difftw@\empty\else \truecolor{\colornew}\rlap{---}\endcolor\truecolor{\colordel}\rlap{#2}\endcolor \fi
%  \ifx\diffon@\empty \let\diffn@xt=\ignorespaces \else \truecolor{\colornew}#1\endcolor \fi
%  \ifvmode \marginalstar\kern-\baselineskip \else \vadjust{\marginalstar}\fi\diffn@xt}

\def\new/{\truecolor{\colornew}}
\def\wen/{\endcolor \ifvmode \marginalstar\kern-\baselineskip \else \vadjust{\marginalstar}\fi}
\def\del/#1\led/{\truecolor{\colornew}\rlap{---}\endcolor\truecolor{\colordel}\rlap{#1}\endcolor
 \ifvmode \marginalstar\kern-\baselineskip \else \vadjust{\marginalstar}\fi}

\def\mod[#1<#2]{\diff{#1}{#2}}
\def\diff#1#2{\def\diffon@{#1}\def\difftw@{#2}%
 \ifx\difftw@\empty\else \truecolor{\colornew}\rlap{---}\endcolor\truecolor{\colordel}\rlap{#2}\endcolor \fi
 \ifx\diffon@\empty\else \truecolor{\colornew}#1\endcolor \fi
 \ifvmode \marginalstar\kern-\baselineskip \else \vadjust{\marginalstar}\fi}
