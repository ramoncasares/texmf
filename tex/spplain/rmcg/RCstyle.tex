...
\def\makeheadline{\vbox to 30pt{\truecolor{Black}\line{\the\headline}%
...
\def\beginnote{\insert\footins\bgroup\strut\truecolor{Black}}
...
\def\endabstract{\par \ifx\keywordsdoc\undefined\else
 \smallskip\sfit\setbox0=\hbox{Keywords:\quad}\hangindent\wd0
 \noindent\box0\keywordsdoc\par\fi \endgroup}
...
\def\toclinezero#1#2#3#4{\centerline{\goto{\bf #1}{#2}}\smallskip}
\def\toclineone#1#2#3#4{\def\3{#3}%
 \line{{\bf \ifx\3\empty\else #3 \fi#1}\leaderfill \goto{#4}{#2}}}
