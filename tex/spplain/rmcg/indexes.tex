...
\def\vfootnote#1{\insert\footins\bgroup
  ...
  \leftskip\z@skip \rightskip\z@skip \spaceskip\z@skip \xspaceskip\z@skip
   \color{Black}\footnoteoptions \textindent{#1}\footstrut\dest\futurelet\next\fo@t} % RMCG
\def\@foot{\endcolor\strut\egroup}
\def\footnoterule{\color{Black}\kern-3pt\hrule width2truein\kern2.6pt\endcolor}
...
\def\r@f#1#2{{\stringaccents\def\&{\string\&}\out{utf}\let^^e2=\@eii
  \expandafter\global\expandafter\let\expandafter\@n@\csname ^^03#2\endcsname
  \expandafter\global\expandafter\let\expandafter\@@n\csname #1#2\endcsname
  \xdef\n@@{\string"#2\string" }}%
 \ifnum0=0\@n@ ?\ifauxf\errmessage{label \n@@ undefined}\fi \else\goto{\@@n}{\@n@}\fi}

\def\r@fx#1#2{{\stringaccents\def\&{\string\&}\out{utf}\let^^e2=\@eii
  \expandafter\global\expandafter\let\expandafter\@n@\csname ^^03#2\endcsname
  \xdef\n@@{\string"#2\string" }}%
 \ifnum0=0\@n@ ?\ifauxf\errmessage{label \n@@ undefined}\fi \else\goto{#1}{\@n@}\fi}
