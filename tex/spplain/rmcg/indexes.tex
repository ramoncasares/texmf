...
\def\save#1{\begingroup
 \def\\{\string\\}\def~{\string~}\def\S{\string\S}%
 \deactivate\dohigh \utfon\out{utf}%
...
\def\files{\begingroup
 ...
 \ifauxf
  ...
  \out{pdf}%
  \def\\{ }\def\-{}\pdft@toc0 \catcode`\(=13 \catcode`\)=13
  \ifcase\pdfoutput
...
\def\r@f#1#2{{\stringate\dohigh\stringaccents\def\&{\string\&}\out{utf}%
...
\def\r@fx#1#2{{\stringate\dohigh\stringaccents\def\&{\string\&}\out{utf}%
  \xdef\n@@{\string"#2\string" }\xdef\@@n{\csname ^^03#2\endcsname}}%
 \setbox0=\hbox{\@@n}\ifdim\wd0=0pt ?\ifauxf\errmessage{label \n@@ undefined}\fi
  \else\goto{#1}{\@@n}\fi}
