...
\ifx\utfon\undefined \input utf8 \fi
...
\def\cm#1fonts{\def\1{#1}\plainfont \utfon
...
\def\ps#1fonts{\def\1{\romannumeral#1}\ansifont \utfon
...
\def\regindex#1#2{\dest\ifnumbering\toc#1{#2}\fi\l@bel{#2}}
...
\def\titlesp#1 \par{\vfill\break\vglue30pt
 \begincenter \parskip=0pt\baselineskip24pt
  \fontzero #1{\def\secid{*}\dest\toc1{#1}}\endcenter
 \bigskip\bigskip}
...
\def\toclineone#1#2#3#4{\bigbreak \def\3{#3}\ifx\3\star\def\3{}\else\def\3{#3\quad}\fi
