...
\def\file{\ifvmode\vskip\parskip\else\par\fi \begingroup
 \ifdim\parindent<20pt \parindent=20pt \fi
...
\def\@file#1{\smallskip \index{#1}1
 ...
 \setupverbatim \input#1 \endgroup\c@ndp@r}
\long\def\c@ndp@r#1{\ifx#1\endgraf\else
 \vskip-\parskip\smallskip\noindent#1\fi}
