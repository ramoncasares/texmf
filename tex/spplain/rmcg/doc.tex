...
% Uses texnansi encoding. No \Gamma - \Omega in fam0
\def\lm#1fonts{\ansifont
 ...
 \font\sevenrm=texnansi-lmr7 % usado por \numbercodeoptions
...
\def\rmcglayout{\vfill\break \lm12fonts \colors
