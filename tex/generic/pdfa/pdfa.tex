...
\def\allhighother{\count255=128
 \loop \catcode\count255=12 \ifnum\count255<255 \advance\count255 by 1\repeat}

% \^^b3 -> ^^f3
{\allhighother \count0="80 \count2="C0
 \loop \lccode`a\count0 \lccode`z\count2
 \lowercase{\expandafter\xdef\csname a\endcsname{z}}%
 \ifnum\count2<"FF \advance\count0 1 \advance\count2 1 \repeat}

\def\utf{\allhighother \catcode`\^^c2=9 \catcode`\^^c3=0 }
